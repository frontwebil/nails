...
function HomePage() {
  ...
  const instagramPosts = [
    ...
    },
    {
      ...
      description:
        "Baby Boomer Maniküre – Eleganz & Natürlichkeit für deine Nägel 💅✨",
      likes: 98,
      comments: 5,
    },
  ];
          ...
          <div className="py-4 border-b border-gray-100">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-4">
                ...
                <a
                  href="https://www.facebook.com/ellanails.beaty"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-pink-600 hover:text-pink-700"
                >
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <Link
                to="/admin"
                className="text-white hover:text-pink-200 text-sm mt-4 block"
              >
                {t("footer.admin")}
              </Link>
            </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl p-8 max-w-md w-full relative">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">{t("thankyou.message")}</p>
              <button
                onClick={() => setShowThankYou(false)}
